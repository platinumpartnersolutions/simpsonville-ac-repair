...
// Navy: #1C3D7A  |  Red: #C41E3A  |  White: #FFFFFF
...
function Hero() {
  ...
  return (
    <section className="hero">
      {/* Van image fills the right two-thirds */}
      <div className="hero-bg">
        <img src="/__mockup/images/van.jpeg" alt="Simpsonville AC Repair Service Van" className="hero-bg-img"/>
        ...
        <Reveal dir="left" delay={100}>
          <div className="offer-card">
            ...
            <div className="offer-logo-wrap">
              <img src="/__mockup/images/logo.png" alt="" className="offer-logo-img" />
            </div>
          </div>
        </Reveal>
      </div>
...
/* ─── SERVICES ─── */
const SERVICES = [
  { icon: "❄️", title: "AC & Heating", slug: "hvac", desc: "Heating and cooling systems that manage indoor temperatures through the Upstate's changing seasons." },
  { icon: "🔧", title: "Plumbing Services", slug: "plumbing", desc: "Household plumbing systems responsible for water flow, drainage, and fixtures throughout the home." },
  { icon: "⚡", title: "Electrical Services", slug: "electrical", desc: "Residential electrical systems that power lighting, appliances, and modern home equipment." },
];
  ...
  return (
    <section className="services-section">
      <div className="sec-inner">
        ...
        <Reveal delay={200}>
          <p className="services-note" style={{color:"rgba(255,255,255,.7)", textAlign:"center", marginTop:32, fontSize:14}}>
      ...
      <div className="sec-inner">
        <div className="nbhd-grid">
          <div className="nbhd-text">
            <Reveal>
              <h2 className="sec-h2">Working in Neighborhoods Across Simpsonville</h2>
            </Reveal>
            <Reveal delay={80}>
            ...
            <Reveal delay={160}>
              <p>From neighborhoods near downtown Simpsonville to growing developments along the city's main corridors, homes throughout the area rely on heating, plumbing, and electrical systems year-round.</p>
            </Reveal>
            <Reveal delay={240}>
          ...
          {/* Van image + schedule card */}
          <div className="nbhd-right">
            <Reveal dir="right" delay={100}>
              <div className="nbhd-img-wrap">
                <img src="/__mockup/images/van.jpeg" alt="Simpsonville AC Repair Van" className="nbhd-img"/>
                <div className="nbhd-img-tag">
                  <img src="/__mockup/images/logo.png" alt="Logo" style={{width:48, height:48, objectFit:"contain"}}/>
                  <div>
...
function Footer() {
  return (
    <footer className="site-footer">
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          <div className="footer-logo-wrap">
            <img src="/__mockup/images/logo.png" alt="Simpsonville AC Repair" className="footer-logo"/>
          ...
          <div className="footer-badges">
            ...
            <span className="fbadge">✅ Est. 2023</span>
            <span className="fbadge">✅ No Payments Until 2027</span>
          </div>
        </div>
        ...
        <div className="footer-col">
          ...
          <div className="footer-cta-block">
            <a href="tel:8108106747" className="footer-cta-btn">(810) 998-6747</a>
          </div>
        </div>
      </div>
      ...
      {/* Red/white/blue stripe at bottom */}
